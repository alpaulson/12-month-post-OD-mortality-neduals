...
NOTE: OPENING OUTPATIENT REVENUE FILE IN A CHUNK BELOW DUE TO COMPUTATIONAL POWER/SIZE ISSUES.
...
NOTE: Some benes have more than one record per day (reflecting either multiple ODs in one day or transfer between facilities). I am going to investigate these after I filter for dual status based on index date.
